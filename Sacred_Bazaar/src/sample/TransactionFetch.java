...
public class TransactionFetch implements Serializable {
    private TransactionFetchRequest transactionFetchRequest;
    public TransactionFetch(TransactionFetchRequest transactionFetchRequest){
        this.transactionFetchRequest=transactionFetchRequest;
    }
    public List<CartProduct> fetch(){
        String query1="Select * from ProductSold where ProductSold.ProductID=products.ProductID && products.Category=? order by DateOfOrder;";
        ...
        try {
            ...
            preparedStatement.setString(1,transactionFetchRequest.getCategory());
